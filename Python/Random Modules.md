...
>
> **Related notes:** [The Logging Module](<The Logging Module.md>) — recording timestamped messages about what your program does · [The Assert Statement](<The Assert Statement.md>) — sanity-check tripwires for catching bugs early · [List Methods](<List Methods.md>) — the 11 methods of the `list` class.
